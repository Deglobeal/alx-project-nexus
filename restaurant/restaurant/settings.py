...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,kachimaxy2.pythonanywhere.com').split(',')
...
# settings.py
LOGIN_REDIRECT_URL = '/api/users/me/'  # or any API endpoint
LOGOUT_REDIRECT_URL = '/api/users/me/'  # optional